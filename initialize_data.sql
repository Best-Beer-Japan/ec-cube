...
VALUES
	...
	(2, 1, NULL, 11, NULL, NULL, 1, 10, NULL, '2', 'BBJ-PF 問い合わせ番号: 111111_20220810_1840', 'テスト購入', '専用会員', 'テスト', 'テスト', '[BBJプラットフォーム経由]', 'support+testkaiin@bestbeerjapan.com', '0123456789', '3510011', 'BBJ', 'プラットフォーム経由', NULL, 16500.00, 0.00, 0.00, 0.00, 1500.00, 16500.00, 16500.00, '請求書払い BBJプラットフォーム専用 【削除不可能】', NULL, now(), now(), now(), NULL, 'JPY', NULL, NULL, 0, 0, 1, 'order', 'テスト購入専用会員', NULL, NULL, DATE_SUB(DATE_FORMAT(now(), '%Y-%m-01 15:00:00'), INTERVAL 1 DAY));
