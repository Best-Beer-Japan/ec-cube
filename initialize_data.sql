...
VALUES
	(1, 2, NULL, NULL, NULL, 11, 'BestBeerJapan', 'プラットフォーム', 'ベストビアジャパン', 'プラットフォーム', 'Best Beer Japan株式会社', '3510011', '朝霞市本町', '1-8-7', 'support@bestbeerjapan.com', '05055392017', NULL, '', NULL, '', NULL, NULL, 0, 0.00, 'プラットフォーム経由の注文です。直接店舗へ商品をお送りください。', NULL, NULL, 0, NOW(), NOW(), 'customer', NULL, '【BBJプラットフォーム経由】', 'ﾍﾞｽﾄﾋﾞｱｰｼﾞｬﾊﾟﾝ', NULL, NULL),
	(2, 2, NULL, NULL, NULL, 11, 'テスト購入', '専用会員', 'テスト', 'テスト', '貴社用のテスト会社', '3510011', '朝霞市本町', '1-1-1', '', '0123456789', NULL, '', NULL, '', NULL, NULL, 0, 0.00, NULL, NULL, NULL, 0, NOW(), NOW(), 'customer', NULL, 'テスト購入専用会員', NULL, NULL, '【→の鉛筆ボタンでメモ拡大】請求書を発行したい時は受注一覧で受注に☑を入れて、「請求月を決定」を押してください。\n\n会員一覧にいないお客様の請求書は発行ができませんのでご注意ください。\n\n入金消込みをしたい場合は対象になる請求書に☑を入れてください。\n\nこのお客様は問屋ですので問屋のグループ価格が反映されます。（会員のグループ変更は会員管理 > 会員一覧 > 詳細 > グループ設定）\n\nメモ欄は削除されるまで残ります。（例：索条しない限り、翌日以降も残ります。)\n');
	(3, 2, NULL, NULL, NULL, 11, '岡山', '源輝', 'オカヤマ', 'ゲンキ', 'BestBeerJapan', '3510011', '朝霞市本町', '1-1-1', 'okayama@bestbeerjapan.com', '08022108912', NULL, '', NULL, '', NULL, NULL, 0, 0.00, NULL, NULL, NULL, 0, NOW(), NOW(), 'customer', NULL, NULL, NULL, NULL, NULL),
