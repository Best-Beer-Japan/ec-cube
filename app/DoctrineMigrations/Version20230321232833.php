 ...
 */
final class Version20230321232833 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $csvOrderStoreNameExists = $this->connection->fetchColumn("SELECT COUNT(*) FROM dtb_csv WHERE csv_type_id = 3 and disp_name = '店舗名'");
        if ($csvOrderStoreNameExists == 0) {
            ...
            $sortNo = $this->connection->fetchColumn("SELECT sort_no FROM dtb_csv WHERE csv_type_id = 3 and disp_name = '会社名'");
    ...
    public function down(Schema $schema) : void
    {
        ...
        $deleteId = $this->connection->fetchColumn("SELECT id FROM dtb_csv WHERE csv_type_id = 3 and disp_name = '店舗名'");
        $sort_no = $this->connection->fetchColumn("SELECT sort_no FROM dtb_csv WHERE csv_type_id = 3 and disp_name = '店舗名'");
